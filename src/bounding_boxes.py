...
class BBox():
    ...
    def compute_bbox(self, region_dict_value):
        ...
        Parameters:
        - self: The self reference.
        - region_dict (dictionary): Dictionary region which consist of the region number, pointcloud data, and centriod.
        
        Return:
        - bbox (list): A list containing a detected object's bounding box coordinates.
        '''        
        ...
        for x, y, z in region_dict_value["points"]:
        ...
        for point in transformed_cloud.points:
            u, v, _ = self.transform_to_image_frame(point)
            x_img.append(u)                
            y_img.append(v)
    ...
    def transform_to_image_frame(self, point):
